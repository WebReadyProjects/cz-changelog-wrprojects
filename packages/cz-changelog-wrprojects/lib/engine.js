...
var headerLength = function headerLength(answers) {
...
var filterSubject = function filterSubject(subject, disableSubjectLowerCase) {
  ...
  return {
    ...
    prompter: function prompter(cz, commit) {
      ...
      cz.prompt([{
        ...
        filter: function filter(subject) {
        ...
        var body = answers.body ? wrap(answers.body, wrapOptions) : false; // Apply breaking change prefix, removing it if already present
